...
interview_position = st.text_input('What role are you applying for?', key="interview_position_behave_key")
interview_name = st.text_input('What is your name?',key="interview_name_behave_key")
if st.button('Start Interview', key="interview_start_key"):
